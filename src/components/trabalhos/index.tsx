            ...
            <div className={style.card}>
                <Link href='https://onebitflix-rust.vercel.app/' className={style.link} target='blanck_'>
                    ...
                    <div className={style.information}>
                        ...
                        <p className={style.description}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit, itaque consectetur. Incidunt, ducimus quod. Numquam illo maiores dolores ab. Voluptas!</p>
                    </div>
                </Link>
            </div>
            <div className={style.card}>
